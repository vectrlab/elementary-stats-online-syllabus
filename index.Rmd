...
2     Mon., Jan. 29         Intro to research and measurement                               Engagement week, Udacity problem set, writing 1      

3	    Mon., Feb. 5          Visualizing data                                                Udacity problem set, Writing 2      
      
4	    Mon., Feb. 12         Central tendency                                                Udacity problem set, Quiz 1
      
5	    Mon., Feb. 19         Variability                                                     Udacity problem set, Writing 3                
                            **Note: Drop/Add Deadline Feb. 19**
      
6	    Mon., Feb. 26         Standardizing                                                   Udacity problem set, Writing 4  

7	    Mon., Mar. 4          Normal distributions                                            Udacity problem set, Quiz 2                

8	    Mon., Mar. 11         Sampling distributions                                          Udacity problem set, Writing 5  

9	    Mon., Mar. 18         Estimation                                                      Udacity problem set, Writing 6                

10    Mon., Mar. 25         Hypothesis testing                                              Udacity problem set, Quiz 3          

  	  Mon., Apr. 1          **Spring recess**
  	                        Cesar Chavez Day (Observed) - Campus Closed Mon. Apr. 1

11	  Mon., Apr. 8          T-Tests, Part 1                                                 Udacity problem set, Writing 7                                   

12	  Mon., Apr. 15         T-Tests, Part 2                                                 Udacity problem set, Quiz 4              

13	  Mon., Apr. 22         One-way ANOVA, Part 1                                           Udacity problem set, Writing 8

14	  Mon., Apr. 29         One-way ANOVA, Part 2                                           Udacity problem set, Writing 9             

15	  Mon., May. 6          Correlation                                                     Udacity problem set, Writing 10                    

      Mon., May 13          Last day of instruction, assignment submission ends 11:59 pm
      
Final Fri., May 16	        Final quiz due, 5:15pm                                          Quiz 5
